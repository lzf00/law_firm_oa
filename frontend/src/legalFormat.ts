...
const labels: Record<string, BilingualLabel> = {
  ...
  COMPLETE: { 'zh-CN': '确认完成', 'en-US': 'Complete' },
  ...
  COURT_DEADLINE: { 'zh-CN': '法院期限', 'en-US': 'Court deadline' },
  ...
  WORK_TASK: { 'zh-CN': '协作任务', 'en-US': 'Work task' },
  MATTER: { 'zh-CN': '案件', 'en-US': 'Matter' },
  CONTRACT: { 'zh-CN': '合同', 'en-US': 'Contract' },
  SEAL_REQUEST: { 'zh-CN': '用印申请', 'en-US': 'Seal request' },
  LEAVE_REQUEST: { 'zh-CN': '请假申请', 'en-US': 'Leave request' },
  EXPENSE_CLAIM: { 'zh-CN': '费用报销', 'en-US': 'Expense claim' },
  COURT_ORDER: { 'zh-CN': '法院或仲裁机构文书', 'en-US': 'Court or tribunal order' },
  STATUTE: { 'zh-CN': '法律法规', 'en-US': 'Statute or regulation' },
  CREATED: { 'zh-CN': '已登记', 'en-US': 'Registered' },
  UPDATED: { 'zh-CN': '已更新', 'en-US': 'Updated' },
  OVERDUE_MARKED: { 'zh-CN': '标记逾期', 'en-US': 'Marked overdue' },
  REOPENED: { 'zh-CN': '已复开', 'en-US': 'Reopened' },

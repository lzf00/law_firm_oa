...
const labels: Record<string, BilingualLabel> = {
  ...
  FAILED: { 'zh-CN': '处理失败', 'en-US': 'Failed' },
  ...
  QUARANTINED: { 'zh-CN': '隔离检查中', 'en-US': 'Quarantined' },
  SCANNING: { 'zh-CN': '安全扫描中', 'en-US': 'Scanning' },
  CONFIRMED: { 'zh-CN': '已确认', 'en-US': 'Confirmed' },
  REJECTED: { 'zh-CN': '已驳回', 'en-US': 'Rejected' },
  RELEASED: { 'zh-CN': '已解除', 'en-US': 'Released' },
  ...
  ENGAGEMENT: { 'zh-CN': '委托协议', 'en-US': 'Engagement' },
  CONFIDENTIALITY: { 'zh-CN': '保密条款', 'en-US': 'Confidentiality' },
  FINAL: { 'zh-CN': '定稿', 'en-US': 'Final' },
  CONFIDENTIAL: { 'zh-CN': '机密', 'en-US': 'Confidential' },
  RESTRICTED: { 'zh-CN': '严格保密', 'en-US': 'Restricted' },
  REVIEW_REQUIRED: { 'zh-CN': '需复核', 'en-US': 'Review required' },
  STANDARD: { 'zh-CN': '标准', 'en-US': 'Standard' },
  REVIEW: { 'zh-CN': '到期复核', 'en-US': 'Review on expiry' },
  DELETE: { 'zh-CN': '到期删除', 'en-US': 'Delete on expiry' },
  ARCHIVE: { 'zh-CN': '到期归档', 'en-US': 'Archive on expiry' },
